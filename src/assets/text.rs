...
pub fn load(stuff_manager: &mut StuffManager) {
	...
	stuff_manager.load_text(TextAsset::new("log_tab_lighthouse_examine_1", "You can feel the warmth comming out from the lighthouse."));
	stuff_manager.load_text(TextAsset::new("log_tab_lighthouse_examine_2", "You should look around."));
